...
export const TEMPLATES = [
  {
    ...
    sections: { intro: true, details: true, position: true, map: true, comps: true, strategy: true, net: true },
  },
  {
    id: "residential",
    label: "Residential",
  ...
  },
  {
    ...
    sections: { intro: true, details: true, position: true, map: true, comps: true, strategy: true, net: false },
  },
  {
    id: "blank",
    label: "Blank",
    desc: "Cover and contact only — build the rest with your own slides.",
    sections: { intro: false, details: false, position: false, map: false, comps: false, strategy: false, net: false },
  },
];
