...
export default function Presentation({
  ...
  useEffect(() => {
    ...
    const measure = () => {
      ...
      if (!w || !h) return;
      setScale(Math.max(0.12, Math.min(w / CANVAS_W, h / CANVAS_H)));
    };
    measure();
    ...
    <div style={{ position: "fixed", inset: 0, background: DARK, zIndex: 9999, display: "flex", flexDirection: "column", fontFamily: "'Libre Franklin', Arial, sans-serif" }}>
      <style>{`
        ...
        @media (max-width: 950px) and (orientation: landscape) {
          ...
          .ds-footer { padding: 3px 0 5px !important; }
          .ds-footer .ds-dot { display: none; }
          .ds-stage { padding: 3px 4px !important; }
          .ds-rotate { display: none !important; }
        }
      ...
      {focusMode && (
        <button
          onClick={() => { setFocusMode(false); if (isFull) toggleFullscreen(); }}
      ...
      <div className="ds-topbarP" style={{ display: focusMode ? "none" : "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "12px 18px", borderBottom: "1px solid rgba(255,255,255,.06)", flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <button
            className="ds-btn"
            onClick={() => { if (fsSupported) toggleFullscreen(); setFocusMode(true); }}
      ...
      <div className="ds-rotate" style={{ display: focusMode ? "none" : "none", alignItems: "center", justifyContent: "center", gap: 8, padding: "6px 14px 0", color: SAGE, fontSize: 11.5 }}>
        <span>Rotate your phone for a wider view</span>
      </div>

      {/* Footer */}
      <div className="ds-footer" style={{ display: focusMode ? "none" : "flex", alignItems: "center", justifyContent: "center", gap: 14, padding: "10px 0 14px" }}>
        {slides.length <= 14 && (
