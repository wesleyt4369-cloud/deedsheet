  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: DARK, zIndex: 9999, display: "flex", flexDirection: "column", fontFamily: "'Libre Franklin', Arial, sans-serif" }}>
      <style>{`
        ...
        @media (max-width: 900px) {
          /* A slide becomes a card that fits its content — nothing gets clipped */
          .ds-stage { align-items: flex-start !important; overflow-y: auto !important; }
          .ds-slidebox {
            aspect-ratio: auto !important; width: 100% !important; height: auto !important;
            max-height: none !important; min-height: 58vh;
          }
          .ds-slidebox > div {
            position: static !important; inset: auto !important; margin: 7px !important;
            overflow: visible !important; min-height: 56vh;
          }
          .ds-mapbox { height: 46vh !important; flex: none !important; min-height: 300px; }
          .ds-strip button { width: 108px !important; }
          /* comp slides: photo above the ledger instead of a cramped two-column split */
          .ds-comprow { flex-direction: column !important; gap: 14px !important; }
          .ds-comprow > div { flex: none !important; width: 100% !important; }
          .ds-comprow img { height: 190px !important; }
        }
        ...
        @media (max-width: 760px) {
          .ds-stage { padding: 8px 8px 16px !important; }
      ...
      <div className="ds-topbarP" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "12px 18px", borderBottom: "1px solid rgba(255,255,255,.06)", flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
          ...
          {fsSupported && (
            <button className="ds-btn" onClick={toggleFullscreen} title="Present full screen">
