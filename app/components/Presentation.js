    ...
    return (
      ...
      >
        <div
          ...
          style={{ width: "min(54%, 620px)", height: "100%", background: GREEN, overflowY: "auto", overscrollBehavior: "contain", paddingBottom: 26, boxSizing: "border-box", boxShadow: "-10px 0 30px rgba(0,0,0,.35)" }}
        >
          {/* Header */}
