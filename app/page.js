...
export default function DeedSheet() {
  ...
  const fonts = `
    ...
    @media (max-width: 640px) {
      ...
      .ds-form button { min-height: 44px; }
    ...
    @media (max-width: 900px) {
      ...
      .ds-rail {
        ...
        background: #12291B; border-right: none; border-top: 1px solid #2E5540;
      ...
      .ds-tabbar { overflow-x: auto; flex-wrap: nowrap !important; gap: 6px !important; }
      .ds-tabbar button { flex: 0 0 auto; padding: 7px 13px !important; font-size: 12px !important; }
    }
  ...
  return (
    <div style={{ background: "#1F3D2B", minHeight: "100vh", fontFamily: "'Libre Franklin', sans-serif" }}>
      ...
      {view === "inputs" && (
        <div className="chrome ds-form" style={{ maxWidth: 760, margin: "16px auto", padding: "0 20px 60px" }}>
          {(() => {
