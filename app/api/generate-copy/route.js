...
export async function POST(request) {
  try {
    const { subject, highlights, tone, listPrice, accessCode } = await request.json();

    // Server-side gate: without the correct code, no API call happens
    // and no credits are spent — even if someone hits this route directly.
